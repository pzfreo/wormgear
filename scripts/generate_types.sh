...
echo "  Processing wormgear-design-v2.0.json..."
"$JSON2TS" "$SCHEMAS_DIR/wormgear-design-v2.0.json" \
...
# Generate enum types
echo "  Processing enums-v2.0.json..."
"$JSON2TS" "$SCHEMAS_DIR/enums-v2.0.json" \
